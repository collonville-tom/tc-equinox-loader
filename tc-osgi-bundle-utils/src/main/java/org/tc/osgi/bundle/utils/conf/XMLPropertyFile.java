...
public class XMLPropertyFile implements IXmlProperty {
    ...
    public void fieldTraking(final Object _obj, final String _declaredField) throws FieldTrackingAssignementException {
        ...
        try {
            ...
            LoggerGestionnary.getInstance(this.getClass()).debug("Recuperation de la valeur pour l'object de class " + _obj.getClass()
                .getCanonicalName() + " pour le champs " + _declaredField);
    ...
    protected void loadXmlFile(final String fileName) throws FieldTrackingAssignementException {
        try {
            LoggerGestionnary.getInstance(this.getClass()).debug("Chargement fichier " + fileName + UtilsPropertyFile.getInstance()
            ...
            final JAXBContext context = JAXBContext.newInstance(objectFactory.getClass().getPackage().getName(), ObjectFactory.class
                .getClassLoader());
